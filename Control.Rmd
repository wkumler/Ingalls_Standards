...
The source code for creating the ClassyFire IDs commented out: *DO NOT RUN THE COMMENTED LINE UNLESS YOU ARE STARTING THE PROJECT FROM SCRATCH!!* It can take several hours just to complete that function.
...
write.csv(Ingalls_Lab_Standards_Classyfire, "Ingalls_Lab_Standards_NEW.csv")
```
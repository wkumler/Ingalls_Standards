...
*Abbreviations*  
To alleviate long commpound names, the primary ID will remain as the KEGG name but a more manageable name will go under the "Figure Names" column.
...
* Vitamins are a mixed bag; some KEGG names are the Vitamin X and others are the the descriptive compound name. Stuck to KEGG conventions.


#### Long-term Changes
* Add in a Figure Name column, or a column with more manageable IDs.

...
-----
## Identify potential abbreviation changes
...
## Show list of compounds to be changed
```{r View abbreviation table, include=TRUE}
View.Abbreviations <- Abbreviations %>%
  select(Compound.Type, Compound.Name_new, Compound.Name_old)
  
write.csv(View.Abbreviations, "View_Abbreviations.csv")
...
Ingalls_Lab_Standards_Abbr <- Ingalls_Lab_Standards_IS %>%
  left_join(Abbreviations %>% select(Compound.Name_new, Compound.Name_old)) %>%
